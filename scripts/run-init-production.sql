-- Production Database Initialization Script for Desa Kaliwungu
...
-- Be careful with this in production - only run if you want to reset everything
...
SELECT 'Database initialized successfully! All tables created and sample data inserted.' as status;
